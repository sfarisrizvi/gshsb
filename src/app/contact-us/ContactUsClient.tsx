...
import { PhoneCall, Mail, MapPin, ShieldCheck, Send, CheckCircle2 } from 'lucide-react';
    ...
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <label htmlFor="fullName" className="text-xs font-semibold text-gray-300 uppercase tracking-wider block">
                    Full Name *
                  </label>
                  <input
                    id="fullName"
                ...
                <div className="space-y-2">
                  <label htmlFor="phoneNumber" className="text-xs font-semibold text-gray-300 uppercase tracking-wider block">
                    Phone Number *
                  </label>
                  <input
                    id="phoneNumber"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <label htmlFor="postcode" className="text-xs font-semibold text-gray-300 uppercase tracking-wider block">
                    Birmingham Postcode *
                  </label>
                  <input
                    id="postcode"
                ...
                <div className="space-y-2">
                  <label htmlFor="serviceSelect" className="text-xs font-semibold text-gray-300 uppercase tracking-wider block">
                    Required Service
                  </label>
                  <select
                    id="serviceSelect"
              ...
              <div className="space-y-2">
                <label htmlFor="messageBox" className="text-xs font-semibold text-gray-300 uppercase tracking-wider block">
              ...
              <button
                type="submit"
                className="btn-emergency-pill w-full text-sm uppercase tracking-wider flex items-center justify-center gap-2 py-4 cursor-pointer"
              >
      ...
      <div className="lg:col-span-5 space-y-6">
        <div className="glass-card p-8 space-y-6 border border-white/10">
          <h2 className="font-epic text-xl font-bold text-white border-b border-white/10 pb-4">
          ...
          <div className="space-y-5 text-sm">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <a href="tel:07900401035" className="text-lg font-bold text-white hover:text-[#e46222] transition-colors">
                  +44 7900 401035
                </a>
              </div>
            </div>
