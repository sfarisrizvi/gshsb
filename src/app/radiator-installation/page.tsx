...
import { Sliders, ThermometerSun, Zap, ArrowRight, PhoneCall, CheckCircle2 } from 'lucide-react';
      ...
      <section className="site-container">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="glass-card p-8 space-y-4">
            ...
            <h3 className="font-epic text-xl font-bold text-white">Designer Column Radiators</h3>
          ...
          <div className="glass-card p-8 space-y-4">
            ...
            <h3 className="font-epic text-xl font-bold text-white">Smart TRV Valves</h3>
          ...
          <div className="glass-card p-8 space-y-4">
            ...
            <h3 className="font-epic text-xl font-bold text-white">MagnaClean Power Flushing</h3>
