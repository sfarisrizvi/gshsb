...
export default function HomePage() {
  ...
  return (
    <div className="space-y-24 pb-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-6 relative min-h-[420px] rounded-24 overflow-hidden border border-white/10 bg-[#07070a]/90 flex items-center justify-center group p-4">
              <Image
                ...
                alt="GSHSB Experienced Heating Engineer"
                fill
              ...
              <div className="absolute bottom-6 left-6 right-6 flex items-center justify-between p-4 rounded-24 bg-[#0f0f13]/90 border border-white/10 backdrop-blur-md">
                <div className="flex items-center gap-3">
                  <Image
                    ...
                    alt="Gas Safe Register Official"
                    width={50}
                    height={35}
            ...
            <div className="lg:col-span-6 space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4 pt-2">
                <div className="flex items-center gap-2 text-xs font-semibold text-gray-200">
                  <CheckCircle className="w-4 h-4 text-[#e46222]" />
      ...
      {/* SERVICES GRID SECTION (Ref 1 inspired modular 24px glass cards with Lottie Icons) */}
      <section className="site-container relative z-10">
      ...
      {/* CLIENT TESTIMONIALS SECTION WITH BLACK & WHITE AVATARS */}
      ...
      {/* REF 2 INSPIRED BRAND MILESTONES & VALUES */}
      <section className="site-container relative z-10">
        <motion.div {...fadeInUp} className="glass-card p-8 sm:p-14 border border-white/10 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="space-y-4 border-l-2 border-[#e46222] pl-6">
              ...
              <h4 className="font-epic text-lg text-white font-bold">FOUNDATION & PRECISION</h4>
              <p className="text-xs text-gray-400 leading-relaxed">
            ...
            <div className="space-y-4 border-l-2 border-[#e46222] pl-6">
              ...
              <h4 className="font-epic text-lg text-white font-bold">SMART THERMAL CONTROL</h4>
              <p className="text-xs text-gray-400 leading-relaxed">
            ...
            <div className="space-y-4 border-l-2 border-[#e46222] pl-6">
              ...
              <h4 className="font-epic text-lg text-white font-bold">SUSTAINABLE COMBUSTION</h4>
              <p className="text-xs text-gray-400 leading-relaxed">
      ...
      {/* GUIDES & ARTICLES SECTION WITH DOWNLOADED BLACK & WHITE COVER IMAGES */}
      <section className="site-container relative z-10 space-y-12">
